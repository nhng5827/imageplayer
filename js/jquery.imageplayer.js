...
(function ($) {
	...
	function create_player() {
	    ...
	    player          = $('<div>').addClass('img_player');
            ...
            play_pause      = $('<a id = "play_pause">').attr('href', '#');
            ...
            scrubber = $('<input id = "range" value="0" type="range" min="0" max="'+String(Number(settings.num_images) - 1)+'" role="input-range">').addClass('scrubber');
	...
	function create_bindings() {
            ...
            scrubber.bind('change', function(e) {
